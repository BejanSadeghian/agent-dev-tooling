...
and `README.md` for the concepts. The short version: every use case is a doer/observer pair,
...
| "Where am I / what next?" | — | `npm run status` (branch, changes, next command); `npm run health` for the whole library |
