...
#
#   bash setup/configure-gh.sh                    # asks who the reviewers are
#   bash setup/configure-gh.sh alice bob          # sets them straight away
#   bash setup/configure-gh.sh --team org/skills  # a whole team instead
#   bash setup/configure-gh.sh --protect          # also require review before merging (needs admin)
#
# What it writes:
#   setup/reviewers.json   the list `npm run ship` asks for
...
# Regenerate with: bash setup/configure-gh.sh
${CODEOWNER_LINE}
OWNERS

echo
echo "Wrote setup/reviewers.json and .github/CODEOWNERS"
