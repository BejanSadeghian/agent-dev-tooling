...
const STAGES = [
  { name: 'lint', script: '.framework/scripts/lint.mjs', perSkill: false, why: 'syntax and house rules across the repo' },
  { name: 'format', script: '.framework/scripts/validate-skill.mjs', perSkill: true, why: 'every skill matches the framework spec' },
  { name: 'tests', script: '.framework/scripts/run-regression.mjs', perSkill: true, why: 'every regression case, Python test and performance budget passes' },
  { name: 'rubric', script: '.framework/scripts/check-rubric.mjs', perSkill: true, why: 'nothing is untested, stale, or missing coverage' },
  { name: 'health', script: '.framework/scripts/health.mjs', perSkill: false, why: 'the library as a whole is not drifting' },
];
